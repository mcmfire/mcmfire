...
<a href="https://stackoverflow.com/users/21778234/fire" target="_blank">
...
<a href="https://www.buymeacoffee.com/mcmfire21" target="_blank">
...
<div align="left">
    <a href="https://code.visualstudio.com/" target="_blank">
        <img style="margin: 10px" src="./assets/vscode-logo.png" alt="VSCode" height="50"/>
    </a>
    ...
    <a href="https://www.w3schools.com/css/" target="_blank">
        <img style="margin: 10px" src="./assets/css3-logo.svg" alt="CSS3" height="50"/>
    </a>  
    <a href="https://www.javascript.com/" target="_blank">
        <img style="margin: 10px" src="./assets/javascript-logo.svg" alt="JavaScript" height="50"/>
    </a>  
    <a href="https://socket.io/" target="_blank">
        <img style="margin: 10px" src="./assets/socketio-logo.png" alt="Socket.IO" height="50"/>
    </a>
    ...
    <a href="https://jinja.palletsprojects.com/en/2.10.x/" target="_blank">
        <img style="margin: 10px" src="./assets/jinja-logo.png" alt="Jinja" height="50"/>
    </a>
    <a href="https://www.w3schools.com/whatis/whatis_json.asp" target="_blank">
        <img style="margin: 10px" src="./assets/json-logo.png" alt="JSON" height="50"/>
    </a>
    ...
    <a href="https://www.sqlite.org/index.html" target="_blank">
        <img style="margin: 10px" src="./assets/sqlite-logo.png" alt="SQLite" height="50"/>
    </a> 
    <a href="https://www.mongodb.com/" target="_blank">
        <img style="margin: 10px" src="./assets/mongodb-logo.png" alt="MongoDB" height="50"/>
    </a>  
    <a href="https://firebase.google.com/" target="_blank">
        <img style="margin: 10px" src="./assets/firebase-logo.png" alt="Firebase" height="50"/>
    </a>  
    <a href="https://cloud.google.com/" target="_blank">
        <img style="margin: 10px" src="./assets/googlecloud-logo.svg" alt="GCP" height="50"/>
    </a>  
    <a href="https://www.apachefriends.org/" target="_blank">
        <img style="margin: 10px" src="./assets/xampp-logo.png" alt="XAMPP" height="50"/>
    </a>
    <a href="https://www.mysql.com/" target="_blank">
        <img style="margin: 10px" src="./assets/mysqlworkbench-logo.png" alt="MySQLWorkbench" height="50"/>
    </a>  
    <a href="https://www.mongodb.com/" target="_blank">
        <img style="margin: 10px" src="./assets/mongodbcompass-logo.png" alt="MongoDBCompass" height="50"/>
    </a> 
    <a href="https://www.php.net/" target="_blank">
        <img style="margin: 10px" src="./assets/php-logo.svg" alt="PHP" height="50"/>
    </a>  
    <a href="https://reactjs.org/" target="_blank">
        <img style="margin: 10px" src="./assets/react-logo.svg" alt="React" height="50"/>
    </a>  
    <a href="https://webpack.js.org/" target="_blank">
        <img style="margin: 10px" src="./assets/webpack-logo.svg" alt="Webpack" height="50"/>
    </a>  
    ...
    <a href="https://gns3.com/" target="_blank">
        <img style="margin: 10px" src="./assets/gns3-logo.png" alt="GNS3" height="50"/>
    </a>  
    ...
    <a href="https://www.canva.com/" target="_blank">
        <img style="margin: 10px" src="./assets/canva-logo.png" alt="Canva" height="50"/>
    </a>  
    <a href="https://www.blender.org/" target="_blank">
        <img style="margin: 10px" src="./assets/blender-logo.png" alt="Blender" height="50"/>
    </a>  
    <a href="https://unity.com/" target="_blank">
        <img style="margin: 10px" src="./assets/unity-logo.png" alt="Unity" height="50"/>
    </a>  
    <a href="https://www.adobe.com/in/products/aftereffects.html" target="_blank">
        <img style="margin: 10px" src="./assets/aftereffects-logo.png" alt="AfterEffects" height="50"/>
    </a>  
    ...
    <a href="https://www.microsoft.com/en-us/microsoft-365/excel" target="_blank">
        <img style="margin: 10px" src="./assets/microsoftexcel-logo.png" alt="Excel" height="50"/>
    </a>
</div>  
